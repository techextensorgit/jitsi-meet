...
function CopyMeetingLinkSection({ url }: IProps) {
    ...
    const createCurrentUrl = "https://claims.phoenixassurance.co.in/meeting?meetingId=" +
        ...
        window.sessionStorage.getItem("meetingID") + "&url=" + url + '#userInfo.displayName=%22%22&userInfo.email=%22%22&MeetingID=' + window.sessionStorage.getItem("meetingID") + "&IsModerator=false"
